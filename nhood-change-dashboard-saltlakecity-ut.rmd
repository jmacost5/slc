...
```{r}
#map.variables <- c("mhv.00","mhv.10","mhv.change","mhv.growth")

#map.values <- c("mhv.00","mhv.10","mhv.change","mhv.growth")

#map.labels <- c("Median Home Value 2000","Median Home Value 2010","Value Change 2000-2010","Growth in Home Value")
...
get_data <- 
  reactive({
            ...
            #variable=="mhv.00" ~ "Median Home Value 2000",
            #variable=="mhv.10" ~ "Median Home Value 2010",
            #variable=="mhv.change" ~ "Value Change 2000-2010"
            #variable=="mhv.growth" ~ "Growth in Home Value")) %>%
            #select(-moe) %>%  
...
```{r}
#d <- merge( slc, d, by.x="geoid-01", by.y="geoid-02", all.x=TRUE )
#x <- d$tractid 
head( slc@data)
